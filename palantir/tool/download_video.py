import os
import argparse
from palantir.tool.video import get_video_url
...
if __name__ == '__main__':
    ...
    cmd = "{} -f 'bestvideo[height=2160][fps=30][ext=webm]/bestvideo[height=2160][ext=webm]' -o {} {}".format(args.youtubedl_path, video_path, url)
    print(cmd)
    os.system(cmd)
